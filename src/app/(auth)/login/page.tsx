    ...
    <div className="w-full max-w-md">
      ...
      <div className="text-center mb-8">
        ...
        <p className="text-sm text-slate-500 mt-1">
          Chào mừng bạn trở lại Gia Hòa Phát
        </p>
      </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg shadow-slate-200/50 border border-slate-100 p-8">
        ...
        <button
          ...
          className="w-full py-2.5 bg-white text-slate-700 text-sm font-semibold rounded-xl border border-slate-200 hover:bg-slate-50 transition shadow-sm flex items-center justify-center gap-3"
        >
